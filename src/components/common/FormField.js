...
export default class FormField extends React.Component {
  ...
  // the field itself
  field() {
    const {input, componentClass, type, placeholder, children, disabled} = this.props;
    return (
      <FormControl {...input} componentClass={componentClass} type={type} placeholder={placeholder} disabled={disabled}>
        {children}
      </FormControl>
    );
  }
